...
The installed set on this fork is **eleven** families as of 2026-09-12 —
...
machine, plus **AtkinsonHyperlegibleNext** (OFL, promoted 2026-09-12 out of
the iOS trial it had been on since build 188 — the fourth sans, filling the
low-vision / hyperlegible cell nothing else in the set covers). (Edgar is
commercial too, and already in the eight.) Dante, Lutetia
...
`crosspoint-fonts` repo from a GitHub runner and can only ever build 8 of the 11
...
locally, builds all eleven on the machine that holds the outlines, and uploads
