...
| ~~Hyphenation~~ | ~~`hyphenationEnabled = 1`~~ | **UNFROZEN 2026-08-25** as the **Line Breaks** row on Typography Settings. Not a hyphen switch: it picks between two line breakers, and the labels say so — Allow hyphens / Keep words whole (renamed from Hyphenated / Whole Words by owner ruling the same day). `docs/line-breaking-2026-08-25.md` |
