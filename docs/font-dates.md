...
- **Almendra's `1350 London` first stage** — removed 2026-08-24 on the evidence above, then RESTORED the same day by owner ruling. It is listed here because the reasoning for removing it still stands: no source claims a 1350 model or London. It ships as a placement decision, not a date. See its table row.
