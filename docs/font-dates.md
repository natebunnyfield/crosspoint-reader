...
| EDITOR | SpaceMono | Space Mono | Benjamin Critton, Colophon | 2016 London | — (born digital) | London / Los Angeles (Colophon Foundry — "a London and Los Angeles-based digital type foundry... Benjamin Critton (US), Edd Harrington (UK), and Anthony Sheret (UK)," [serbyte.net](https://www.serbyte.net/fonts/designers/colophonfoundry)) | Editor (writing) face, `src/notes/EditorFonts.h`; removed from `installed_families:`-equivalent compiled-in editor list on 2026-08-15 (owner ruling) though the recipe, `builtinFonts/*.h` and this picker label stay. Design year and credit read directly from the shipped `SpaceMono-Regular.ttf`'s own name table: ID 0 "Copyright 2016 The Space Mono Project Authors", ID 8 (manufacturer) "Colophon Foundry & Benjamin Critton", ID 9 (designer) "Colophon Foundry + Benjamin Critton". [METADATA.pb](https://raw.githubusercontent.com/google/fonts/main/ofl/spacemono/METADATA.pb) `date_added: 2016-06-20` is the same year, not a second stage. "London" in the picker's single-city lineage is one of Colophon Foundry's two offices; no source found pins Space Mono to one city specifically, so this table records both rather than picking one. Row added 2026-09-16; had no row here before |
| EDITOR | IBMPlexMono | IBM Plex Mono | Mike Abbink, Paul van der Laan & Pieter van Rosmalen | 2017 New York, Austin, The Hague & Eindhoven | — (born digital) | New York / Austin, USA (Abbink — per `src/FontDisplayNames.h`'s own citation, "Bold Monday's own IBM page credits 'Mike Abbink, New York/Austin'"; **not independently re-verified in this pass** — the current `boldmonday.com/support/about/` page names Abbink only as IBM's Executive Creative Director, ex-MetaDesign San Francisco, with no New York or Austin found there); The Hague, Netherlands (van der Laan — "works... from a studio near the royal palace in The Hague," [boldmonday.com/support/about/](https://boldmonday.com/support/about/)); Eindhoven, Netherlands (van Rosmalen — "runs Bold Monday's Eindhoven office," same page) | Editor (writing) face, `src/notes/EditorFonts.h`; removed from the compiled-in editor list on 2026-08-15 (owner ruling) though the recipe and this label stay. Copyright 2017 IBM Corp. in the shipped `IBMPlexMono-Regular.ttf`'s own name table (ID 0); designer ID 9 "Mike Abbink, Paul van der Laan, Pieter van Rosmalen"; manufacturer ID 8 "Bold Monday". One stage, born digital: a contemporary original by named living designers gets no promoted earlier stage under this table's model-dating rule, which is reserved for historical models (1470 Venice, 1722 London). Row added 2026-09-16; had no row here before |
| EDITOR | iAWriterQuattro | iA Writer Quattro | Mike Abbink, Paul van der Laan & Pieter van Rosmalen; Oliver Reichenstein | 2017 New York, Austin, The Hague & Eindhoven; 2018 Zurich | — (born digital) | New York / Austin, USA & The Hague / Eindhoven, Netherlands (the Plex team, stage 1 — sourced under IBMPlexMono above); Zurich, Switzerland (iA's own office, stage 2 — [ia.net/about](https://ia.net/about): "iA Zurich") | Editor (writing) face, `src/notes/EditorFonts.h` — the one iA face that has ever also been offered as a reading face (`alsoReading`; owner ruling 2026-08-09, reversed 2026-08-21, *"remove ia quattro from reading fonts"*; the flag stays in `EditorFonts.h` to keep that reversal visible). TWO stages: the shipped `iAWriterQuattroS-Regular.ttf`'s own name table copyright reads "2017 IBM Corp. and iA Inc." and designer ID 9 "Mike Abbink, Paul van der Laan, Pieter van Rosmalen, Oliver Reichenstein" — the same Plex-plus-Reichenstein credit all three iA faces here carry. iA's own announcement, ["iA Writer has three custom made writing fonts that are available for download"](https://ia.net/topics/a-typographic-christmas) (ia.net, 14 Dec 2018), dates Quattro's own release to that year — "This year, we add a third font with four character sizes, called iA Writer Quattro" — one year after Duo (see the iAWriterDuo row), and is the source for the second stage here. Row added 2026-09-16; had no row here before |
| EDITOR | iAWriterDuo | iA Writer Duo | Mike Abbink, Paul van der Laan & Pieter van Rosmalen; Oliver Reichenstein | 2017 New York, Austin, The Hague & Eindhoven; 2017 Zurich | — (born digital) | New York / Austin, USA & The Hague / Eindhoven, Netherlands (the Plex team, stage 1); Zurich, Switzerland (iA's own office, stage 2) | Editor (writing) face, `src/notes/EditorFonts.h`; never offered as a reading face. Shipped `iAWriterDuoS-Regular.ttf`'s own name table copyright reads "2017 IBM Corp. and iA Inc.", manufacturer ID 8 "Bold Monday and Information Architects Inc.", designer ID 9 the same four names as Quattro above. iA's own post ["From Monospace to Duospace: In Search of the Perfect Writing Font"](https://ia.net/topics/in-search-of-the-perfect-writing-font), dated 23 Nov 2017, introduces the duospaced IBM-Plex-based face this row is named for — "IBM Plex, like Nitti, was love at first sight... Since it's open source, we could alter it as we wished" — so both stages land in 2017, unlike Quattro's second-year 2018 stage. Row added 2026-09-16; had no row here before |
| EDITOR | iAWriterMono | iA Writer Mono | Mike Abbink, Paul van der Laan & Pieter van Rosmalen; Oliver Reichenstein | 2017 New York, Austin, The Hague & Eindhoven; 2018 Zurich | — (born digital) | New York / Austin, USA & The Hague / Eindhoven, Netherlands (the Plex team, stage 1); Zurich, Switzerland (iA's own office, stage 2) | Editor (writing) face, `src/notes/EditorFonts.h`; never offered as a reading face. **Not the classic Nitti Typewriter.** `src/FontDisplayNames.h`'s comment on this row records that an earlier version of this entry wrongly carried Nitti's credit ("Pieter van Rosmalen, Bold Monday; Oliver Reichenstein", 2009 The Hague) and that this was corrected: the shipped `iAWriterMonoS-Regular.ttf`'s own name table copyright reads "2017 IBM Corp. and Information Architects GmbH" and lists Abbink among the designers (ID 9, the same four-name credit as Duo and Quattro), neither of which is true of a 2009 Bold Monday face. iA's own ["A Typographic Christmas"](https://ia.net/topics/a-typographic-christmas) post (ia.net, 14 Dec 2018) explains the naming: "iA Writer started off with one font. The classic Nitti, designed by Bold Monday" — describing the face THIS ONE REPLACED, not this one. Dated 2018 for its second stage on the same footing as Quattro, both described in that post as the later additions while Duo is "last year". Nitti's own credit now lives on the NittiTypewriter row below, where it is finally attached to the typeface it actually describes. Row added 2026-09-16; had no row here before |
| EDITOR | PragmataPro | PragmataPro | Fabrizio Schiavi | 2010 Piacenza | — (born digital) | Piacenza, Italy (Fabrizio Schiavi Design / FSD — "he left to set up his own graphic design studio, FSD (Fabrizio Schiavi Design), in Piacenza," [Wikipedia: Fabrizio Schiavi](https://en.wikipedia.org/wiki/Fabrizio_Schiavi)) | Editor (writing) face, `src/notes/EditorFonts.h`, one of two commercial rows in the editor group (the recipe is committed, the TTF is not — `lib/EpdFont/local_fonts/PragmataPro-*.ttf`). Design year from the shipped `PragmataPro-Regular.ttf`'s own name table, ID 0: "Copyright (c) 2010 by Fabrizio Schiavi"; designer ID 9 "Fabrizio Schiavi" alone. One stage: `fsd.it` still sells it as a continuously revised single work, so a later version number is not a second stage under this table's adjacent-year / single-work convention. Row added 2026-09-16 — `src/FontDisplayNames.h`'s own comment on this row ("No row in docs/font-dates.md yet — add one there if that table is regenerated") flagged the gap this closes |
| EDITOR | NittiTypewriter | Nitti Typewriter | Pieter van Rosmalen | 2007 | No place: Bold Monday's offices near The Hague and Eindhoven are the foundry's today, not where a 2007 face was drawn, and nothing dates the studio to the design — bare year, same treatment as Host Grotesk | same as Creation place | Copyright © 2007–2016 Bold Monday, read directly from the shipped `NittiTypewriter-Regular.ttf`'s own name table (ID 0); designer ID 9 "Pieter van Rosmalen" alone. Bold Monday's founding year (2008, [boldmonday.com/support/about/](https://boldmonday.com/support/about/)) does not contradict a 2007 design: van Rosmalen drew it before the foundry he co-founded existed, and the foundry's copyright notice covers work it later published — the same shape as any designer who incorporated after drawing a face. **2009 was a stale "conservative minimum" that leaned on a since-corrected sibling row** — it argued from "iAWriterMono's FontDisplayNames.h colophon carries '2009 The Hague' on the strength of [iA's Dec 2018] post," but that colophon has been rewritten: Mono is not a Nitti descendant at all, it is IBM-Plex-derived like Duo and Quattro (see the iAWriterMono row above), and its current lineage cites no Nitti date whatsoever. With that support gone, the primary source — the font's own copyright string — is used directly: 2007. Version 5.0, 1220 glyphs, Regular only — Bold/Italic/BoldItalic are synthesised at build time in this firmware. COMMERCIAL: the recipe is committed, the TTF is not. **Fixed 2026-09-16** to match `src/FontDisplayNames.h`, which has read 2007 all along |
...
| S | HerosTextCut | Heros Text Cut | Max Miedinger & Eduard Hoffmann; Bogusław Jackowski & Janusz M. Nowacki; text cut 2026 | 1957 Münchenstein, Switzerland; 2009 Gdańsk; 2026 | as TeX Gyre Heros | as TeX Gyre Heros | The text cut of the row above, installed 2026-09-14 — TeX Gyre Heros v2.004 put through a punchcutter's corrections for the 9–13 pt slots on the outlines (`tools/textcut/textcut_curves.py`, record in `docs/heros-text-cut-2026-09-14.md`): stems +5 u a side horizontal-only, sub-pixel traps at the line-line crotches, every digit on the cap row, advances and alignments stock, Heros's GPOS kerning carried EXACTLY — the fitted pairs this row used to claim were withdrawn in round 14, measured, and none ships. Its f-ligatures and the 252 codepoints `reading` asks for that the cut does not carry come from stock Heros through the recipe's `fallback_head:`, not from the serif at the head of the ordinary chain (round 15). The 2026 stage is this repository's own work and therefore a reliable date; the earlier stages are Heros's and are not re-attributed. GFL permits a modified redistribution under a different name; sources are the four TTFs in `local_fonts/`, mirrored to the private crosspoint-local-fonts repo for CI |
...
| S | VandenKeere | DTL VandenKeere | Hendrik van den Keere; Frank E. Blokland | 1575 Ghent; 1995 's-Hertogenbosch | Ghent, Flanders (now Belgium). Van den Keere was born in Ghent about 1540, worked there, and from 1570 until his death in 1580 was Christophe Plantin's exclusive supplier of type; [Wikipedia](https://en.wikipedia.org/wiki/Hendrik_van_den_Keere). The model is his **Parangon Romein**, cut 1575 and first used by Plantin in 1576, who called it *"Reale Romaine"* -- [DTL's own page](https://www.dutchtypelibrary.nl/DTLVandenKeere.html) and its [supplement](https://www.dutchtypelibrary.nl/VandenKeere_left_supp.html), which quotes Vervliet calling it *"one of the truly outstanding designs originating in the Low Countries"*. **GHENT IS THE ROMAN'S CITY**, and Plantin's Antwerp is deliberately not used: Plantin printed with the type, van den Keere cut it | 's-Hertogenbosch, Netherlands (Dutch Type Library, Frank E. Blokland -- the same studio and the same digitiser as DTL Romulus). Drawn at DTL Studio **1991-1995** ([Fonts In Use](https://fontsinuse.com/typefaces/30273/dtl-vandenkeere)); the year in the picker is **1995**, taken from the shipped files' own name tables (*"created on 01-05-1995"* Regular, *"2-5-95"* Bold, both *"by Dutch Type Library"*), on the same terms as DTL Romulus's 2003 -- DTL publishes no release year. The **Italic file is dated 1997** (*"created on 27-05-97 / 1997"*), two years after the roman; not a second stage, the same family completed | **Added 2026-09-07** straight into `installed_families:`, the **thirteenth** family and the sixth commercial one. Files: *DTL VandenKeere SD* Regular, Italic and Bold, staged gitignored in `lib/EpdFont/local_fonts/` under clean names, never committed. **THE ITALIC'S MODEL IS ANOTHER PUNCHCUTTER'S AND EARLIER THAN THE ROMAN'S**: DTL's supplement page is headed *"Hendrik van den Keere / François Guyot"* and credits the italic to Guyot's **Ascendonica Cursief of c. 1557**, with *"shape, weight, and contrast adapted"* to sit with the roman and the capitals redrawn from the Parangon's rather than from Guyot's. Guyot (c. 1505-1570) was a French punchcutter registered in Antwerp from 1539 who supplied Plantin from 1558 until his death. **The picker credits van den Keere and Blokland only**, and the origin is the ROMAN's 1575, on the Dante precedent recorded below (*"a roman-led book face whose italic is secondary"*) and because DTL's own product page heads the face with those two names. Guyot is recorded here rather than dropped; promoting the origin to 1557 Antwerp is a defensible alternative; it would change the Designer column and the colophon's first line but NOT the picker position, since 1557 still falls between Edgar's 1722 and Dante's 1501. **"SD" IS NOT SOURCED**: DTL sells this face as D, SD, T and ST series and expands none of the letters on its product, shop or supplement pages. What the shop shows is that SD carries six faces (Regular/Medium/Bold x roman/italic) while T and ST carry a single Regular each, so SD is the only series with three real cuts to ship. **NO BOLD ITALIC EXISTS** in the SD series on disk, so that one style is synthetic (embolden 0.034 em, y_ratio 0.35); the other three are real. Fit and measurements: [docs/vandenkeere-2026-09-07.md](vandenkeere-2026-09-07.md) |
...
| S | AtkinsonHyperlegibleNext | Atkinson Hyperlegible Next | ; Elliott Scott & Craig Dobie; Elliott Scott & Megan Eisworth | 1832 London; 2019 New York; 2025 Los Angeles | London, England (model: the style Figgins printed as "sans serif" in his 1832 specimen — the Lexica Ultralegible row's stage 1, applied to the face Lexica was forked from) | New York, USA (Applied Design Works, NY/LA, for Braille Institute of America, Los Angeles — the 2019 Atkinson Hyperlegible); Los Angeles, USA (the 2025 Next release, Braille Institute's own dateline; drawn by the same studio) | **Added 2026-09-12 with its promotion to S** (owner ruling, out of the iOS trial it had been on since build 188; on trial from the 2026-09-11 ruling *"drop lexica and atkinson soft, add atkinson hyperlegible next at 365 weight"*). In `installed_families:`, the eleventh, and the fourth sans — the low-vision / hyperlegible cell this table's A-tier note says nothing else covers. SIL OFL 1.1, `googlefonts/atkinson-hyperlegible-next`, URLs pinned to commit 7925f50f (the repo has no tags); instanced from the variable TTFs at wght 365 (regular, italic) and 600 (bold, bold italic — 700 on the first cut, moved the same day). Stage 1 is Lexica's, on the same 2026-08-03 ruling: Figgins' 1832 specimen is where "sans serif" is first printed as the name of the style, and no individual is recorded for it. Stage 2 is Lexica's too — Atkinson Hyperlegible 2019, Applied Design Works, Elliott Scott lead designer and Craig Dobie creative director (that row's citations). Stage 3: Atkinson Hyperlegible Next, released **February 10, 2025** — the Braille Institute announcement carries the dateline *"Los Angeles, February 10, 2025"* ([Braille Institute](https://www.brailleinstitute.org/about-us/news/braille-institute-launches-enhanced-atkinson-hyperlegible-font-to-make-reading-easier/), which quotes Brad Scott, Founder and Principal of Applied Design) and PRINT credits the Applied Design team *"including Elliott Scott (creative director) and Megan Eisworth (designer)"* with the foundry Letters from Sweden collaborating ([PRINT](https://www.printmag.com/type-tuesday/atkinson-hyperlegible-next-applied-design/)). The two individuals go in the Designer column; the studio and the foundry stay in this cell, per the Designer-column rule below. **The place of stage 3 is the release's dateline, not the studio's desk**: Applied Design is NY/LA and neither source says which office drew Next, so the one city a source attaches to the 2025 release is taken and flagged here. The shipped file's own `name` table reads version 2.001, copyright "2020-2024 The Atkinson Hyperlegible Next Project Authors" — the 2020 is the upstream Atkinson copyright and 2024 the last authoring year, neither a release, so 2025 stands alone (see Excluded dates). Coverage measured on the instanced TTFs: 362 codepoints, Latin-1 94/96, Latin Extended-A 93/128, 4 Greek, no Cyrillic |
...
| B | InknutJunicode | Inknut + Junicode | ; Claus Eggers Sørensen; ; Peter S. Baker | 1469 Venice; 2014 Amsterdam; 1703 Oxford; 1998, 2023 Charlottesville, Virginia | Venice, Italy (Inknut's model: Johannes de Spira's roman, 1469) and Oxford, England (Junicode's model: the OUP "Pica Roman" purchased 1692, printed in Hickes' Thesaurus 1703–05) | Amsterdam, Netherlands (Sørensen) and Charlottesville, Virginia, USA (Baker) | TWO TYPEFACES IN ONE FAMILY, so both columns carry all four stages, roman first: Inknut Antiqua supplies regular and bold, Junicode supplies the real cut italics that Inknut's foundry repo has at no weight. Rows above for [InknutAntiqua62](#) and [Junicode](#) are the source of every fact here — this row only orders them. Stages 1 and 3 carry no person on purpose, matching each source row's own per-stage split: Inknut's Venetian model has no named designer (the InknutAntiqua62 row above declines to promote de Spira) and Junicode's model is Oxford University Press, an institution — hence the doubled interior gap in the Designer column, `; Claus Eggers Sørensen; ; Peter S. Baker`, the exact form the "How an empty slot is written" rule above uses as its own worked example. **Full string restored 2026-08-28, matching `src/FontDisplayNames.h`.** The picker used to pair two lines per stage (person, then year-place) inside a two-line budget, which could not fit "1998, 2023 Charlottesville, Virginia" for Junicode's revision and dropped the 2023 year and ", Virginia" — the state this row described until now. It has since moved to one bulleted line per stage plus a `groupBreakAfter` blank line between Inknut's story and Junicode's (five lines total; `kColophonLines` raised to 5 to hold it — see `FontDisplayNames.h`'s `subtitle()` comment), so the full string fits and both years are restored. The display name is also `Inknut + Junicode`, not `Inknut Antiqua + Junicode` (owner 2026-08-28) — the on-card directory name stays `InknutJunicode`, since renaming it would orphan every installed copy; only the picker label changed. **This row was stale until fixed 2026-09-16**: the Designer column was missing both empty stage slots and the Lineage column still read the old compressed `1998 Charlottesville` and the old `Inknut Antiqua + Junicode` display name |
| S | Almendra | Almendra | Blackletter; Ana Sanfelippo | c. 1450 Mainz; 2011 Buenos Aires | **Stage 1 names a STYLE, not a face** (owner 2026-08-27, first: *"add a style for author and a rough year and place for when this style started or peaked or earliest established,"* then, hours later: *"use c. 1450 mainz or something more accurate for blackletter type used in print"*). Gutenberg's Mainz workshop cut the earliest European printing types around 1450 — the Donatus-Kalender type, placed 1449–1452 on typographic evidence, followed by the c. 1454 42-line Bible type — and both are blackletter (textura), modelled on the Mainz liturgical manuscript hand, so **c. 1450 Mainz** is the point the gothic hand became TYPE rather than writing. The "c." is doing real work and is not sharpened to 1454, a different, later type. Blackletter (not chancery) also fits the letterforms better: Almendra is upright, dark and pen-formed, and Sanfelippo's own description names both "chancery and gothic hands" — gothic being the half the face actually favours. This is NOT a claim that Sanfelippo worked from Gutenberg: she names a class of hands, not a printer. Anchors considered and REJECTED (kept so they are not re-proposed): textura's manuscript peak, c. 1300 northern France (predates type; this table's stage 1 is a lineage of faces, not of hands); Arrighi's *La Operina*, Rome 1522, a crisp date for the chancery half she also names, but a cursive italic, which Almendra is not; the humanist cursive it grew from, c. 1420 Florence (Niccoli, Poggio). SORT: 1450 seats the face just before Inknut (1469), at the old end of the picker — superseding both the 2026-08-24 `1350 London` ruling (wrong twice over: English chancery hand is c. 1400+, and 1350s London actually wrote Anglicana, with textura for formal books, not chancery at all) and the intervening one-stage `2011 Buenos Aires` form this row carried between 2026-08-27's two rulings that same day. Full history in `src/FontDisplayNames.h`'s comment above this row, kept there because it was contested twice | Buenos Aires, Argentina (Sanfelippo; drawn as her graduation typeface at CDT UBA) | **Design year 2011, sourced independently of the style stage.** Three primary sources date the DESIGN to 2011 and none of them dates a model: (1) the shipped TTFs' own name ID 0, `Copyright (c) 2011-2012, Ana Sanfelippo`, two adjacent years so 2011 under the adjacent-year rule; (2) [METADATA.pb](https://raw.githubusercontent.com/google/fonts/main/ofl/almendra/METADATA.pb), `date_added: 2011-12-19`; (3) [DESCRIPTION.en_us.html](https://raw.githubusercontent.com/google/fonts/main/ofl/almendra/DESCRIPTION.en_us.html), "related to the chancery and gothic hands" — classes of hands worked by many anonymous scribes, not one dated model, and naming no country. Devroye agrees and adds the school. **This row is fixed as of 2026-09-16 to match `src/FontDisplayNames.h` exactly** — it previously read `1522 Rome; 2011 Buenos Aires` with designer `Chancery hand; Ana Sanfelippo`, describing the state after the FIRST 2026-08-27 ruling but not the SECOND one the same day that replaced it; see the (now resolved) "Almendra: this table is BEHIND" note further down and the Excluded-dates entry below. **Do not cite this row as evidence for a 1350 anything** — that ruling was superseded, not merely one of two live readings. |
| A | Albo | Albo | Nate Bunnyfield | 2026 Omaha | — (born digital) | Omaha | IN-HOUSE, and the only row here that is: drawn 2026-09-12 to 2026-09-14 in `~/src/crosspoint-simulator/tools/wedge_serif` over ~100 rounds, every shape ruled by the owner. Designer and place are HIS OWN STATEMENT, 2026-09-14, asked and answered: the NAME is "Nate Bunnyfield" and the PLACE is "Omaha", confirmed by him when he saw them written down. The place column reads plain "Omaha" and not "Omaha, Nebraska, USA" on purpose — the first version expanded it, and expanding a person's statement of where they are is an inference, however safe the inference looks. Every other row's place is cited from a foundry or a designer's own page; this one is cited from the designer. No historical model and no original author, so the creation place is born-digital and `origin` repeats the lineage's only stage rather than naming an earlier type: there is no earlier type. Full record: `docs/wedge-serif-exploration.md` in the simulator repo |
...
**Six editor (writing) families had no row here at all until 2026-09-16**:
`SpaceMono`, `IBMPlexMono`, `iAWriterQuattro`, `iAWriterDuo`, `iAWriterMono` and
`PragmataPro` were credited only in `src/FontDisplayNames.h`. This paragraph
used to say `iAWriterMono` was "credited... van Rosmalen/Bold Monday for the
2009 Nitti" — that was already wrong when written: the header's iAWriterMono
row had by then been corrected away from Nitti's credit entirely (see the
NittiTypewriter row's Basis cell) to the same IBM-Plex-derived credit its Duo
and Quattro siblings carry, `Mike Abbink, Paul van der Laan & Pieter van
Rosmalen; Oliver Reichenstein`. All six families now have rows above, each
sourced from its own shipped font's name table plus Bold Monday's and iA's own
pages.
...
outstanding `& Jean-Baptiste Levée` at the same time. Almendra briefly left
that group when its 2026-08-24 rewrite dropped the invented first stage to one
name against one stage — but the owner's second 2026-08-27 ruling ("add a
style for author...") put it back with a per-stage split of its own,
`Blackletter; Ana Sanfelippo` against `c. 1450 Mainz; 2011 Buenos Aires`. This
sentence was wrong from 2026-08-27 until fixed here 2026-09-16; see the
Families table row above.

**No rows are unpaired any longer, and this section was stale about both of the
two it used to name.** Antykwa Półtawskiego was resolved 2026-08-13 — the
paragraph above ("Antpolt gained its stage-1 credit in the same pass") already
says so, and the Families table row's Designer column has carried `Adam
Półtawski; Bogusław Jackowski & Janusz M. Nowacki` since that date; this
section simply was never updated to match and claimed the opposite. iA Writer
Mono is resolved here, 2026-09-16, by the new row above, whose Designer column
now carries `Mike Abbink, Paul van der Laan & Pieter van Rosmalen; Oliver
Reichenstein` against its two stages — the same Plex-plus-Reichenstein credit
iA Writer Duo and Quattro carry, once Mono's own credit was corrected away from
Nitti's (see the NittiTypewriter row's Basis cell for that correction).
...
- **Almendra's `1350 London` first stage** — removed 2026-08-24 on the evidence
  ...
  **Superseded again, hours later on 2026-08-27.** The owner's follow-up ruling
  — *"use c. 1450 mainz or something more accurate for blackletter type used in
  print"* — restored a first stage, but a STYLE stage (`Blackletter`), not the
  rejected `1350 London` face-model stage this bullet is about. The row now
  carries two stages, `c. 1450 Mainz; 2011 Buenos Aires`, and sorts on 1450, not
  2011. This does not reopen the finding above — there is still nothing
  *accurate* to name as a face-model — it answers a different question the
  owner asked next: a rough year/place for the STYLE, not the model. Full
  reasoning is in the Families table row above and in `src/FontDisplayNames.h`'s
  comment; this bullet's "settled... carries one stage... sorts on 2011" is
  history, current as of 2026-08-27's first ruling only, superseded the same day
  and fixed here 2026-09-16.
...
- **Atkinson Hyperlegible Next's 2020 and 2024 copyright years** — the shipped
  file's `name` table reads "2020-2024 The Atkinson Hyperlegible Next Project
  Authors": 2020 is the upstream Atkinson Hyperlegible copyright and 2024 the
  last authoring year, neither a release. The release is 2025-02-10 (Braille
  Institute's own dateline), so 2025 stands alone. (This bullet said the
  family was "not installed here" until 2026-09-12, when it was promoted and
  given its own row above.)
...
| Doves | 1900 Hammersmith | c. 1470 Venice | **Sourced here**: the Doves Type row's own Creation-place cell says the type "was cut after Jenson", and the Rosarivo row dates Jenson's roman to 1470 Venice |
...
| Doves | c. 1470 Venice | **sourced** — "cut after Jenson" + the Rosarivo row's dating |
...
| VandenKeere | 1575 Ghent | own stage 1 (van den Keere's Parangon Romein). The ITALIC's model is earlier -- Guyot's Ascendonica Cursief, c. 1557 -- and the roman wins on the Dante precedent, *"a roman-led book face whose italic is secondary"*. Deliberately NOT chased back to Jenson: this table names no Venetian model for a Flemish roman, and inventing one is the claim `earliestYear`'s comment warns against |
...
### ✓ Almendra: fixed 2026-09-16, was behind `FontDisplayNames.h`

The Almendra row above used to read `1522 Rome; 2011 Buenos Aires` with
designer `Chancery hand; Ana Sanfelippo`, and the Excluded-dates section used
to say the row "carries one stage, `2011 Buenos Aires`, and sorts on 2011" —
neither matched what shipped. `FontDisplayNames.h` has carried `c. 1450 Mainz;
2011 Buenos Aires` with designer `Blackletter; Ana Sanfelippo` and `earliestYear`
1450 since 2026-08-27, implementing a LATER owner ruling from that same day
(*"use c. 1450 mainz or something more accurate for blackletter type used in
print"*) whose reasoning is recorded in full in that header's comment. This was
flagged 2026-09-06 as wanting the edit and left unmade; both the Families row
above and the Excluded-dates entry now carry the same values and reasoning as
the header.
...
### DTL VandenKeere ships (2026-09-07)

**Added straight into `installed_families:`** on the owner's instruction, the
**thirteenth** family and the sixth whose outlines are commercial, gitignored
and unrebuildable from a clean clone (after Dante, Lutetia Nova, Doves,
WarblerText, and the two that were cut).

**Origin 1575 Ghent** — Hendrik van den Keere's Parangon Romein, cut 1575 and
first used by Plantin in 1576. It sorts eighth in the picker, between Edgar
(1722 London) and Dante (1501 Venice).

**The one attribution question, stated rather than settled silently.** The
family's italic follows **François Guyot's Ascendonica Cursief of c. 1557**,
which is eighteen years EARLIER than the roman's model and by a different hand
— DTL's supplement page is headed with both names. The picker takes the roman's
1575 and credits van den Keere and Blokland, on the Dante precedent above (*"a
roman-led book face whose italic is secondary"*) and because DTL's own product
page heads the face *"DTL VandenKeere | Hendrik van den Keere | Frank E.
Blokland"*. **Taking 1557 Antwerp instead is defensible**: it would credit Guyot
in the Designer column and change the colophon's first line. It would NOT move
the family in the picker — 1557 still falls between Edgar's 1722 and Dante's
1501, so the position is eighth either way, which is the same shape as Dante's
own 1495-vs-1501 note above. Not taken, and recorded so the question is not
re-opened by accident.

**1995, not 1991.** The design ran 1991–1995 at DTL Studio; the year in the
picker is the one in the shipped files' own name tables, exactly as DTL
Romulus takes 2003 from its file rather than from a DTL page that gives none.
The Italic file is dated 1997 and that is not a second stage.

Installed set is **thirteen**.
