...
void WifiSelectionActivity::promptPasswordEntry() {
  ...
  startActivityForResult(makeTextEntryActivity(renderer, mappedInput, tr(STR_ENTER_WIFI_PASSWORD),
                                               "",  // No initial text
...
void WifiSelectionActivity::promptHiddenSsid() {
  ...
  startActivityForResult(makeTextEntryActivity(renderer, mappedInput, tr(STR_ENTER_WIFI_SSID),
                                               "",  // No initial text
