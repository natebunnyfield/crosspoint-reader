...
class CrossPointSettings {
 ...
 private:
  ...
  // Reads whichever settings file exists. Call loadFromFile() instead — it
  // wraps this and then applies normalizeRetiredSettings().
  bool loadSettingsFromDisk();
  // Pins values whose UI has been withdrawn back into a valid, reachable state.
