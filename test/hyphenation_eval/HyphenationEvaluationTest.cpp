...
// Only English and Spanish tries are compiled in; the other eight Liang pattern
// sets were removed with the UI languages. Their eval cases went with them —
// getLanguageHyphenatorForPrimaryTag returns nullptr for an unbuilt tag, so they
// could only ever assert that hyphenation does nothing.
